...
public class Test01 {
	public static void main(String[] args) {
		...
		long minutesBetween = ChronoUnit.MINUTES.between(startDateTime, endDateTime); // Minutos entre duas datas e
																						// horas
		...
		LocalDateTime subtractedDateTime = endDateTime.minus(45, ChronoUnit.MINUTES); // Subtrai 45 minutos da data e
																						// hora final
