...
/*
Wrappers são classes que encapsulam tipos primitivos de dados em Java, transformando-os em objetos. 
Eles são úteis quando precisamos trabalhar com tipos primitivos em contextos que requerem objetos, 
como coleções (Listas, Conjuntos, Mapas) e APIs que esperam objetos em vez de tipos primitivos.
...
Os wrappers também fornecem métodos úteis para conversão entre tipos primitivos e objetos, 
operações matemáticas, manipulação de strings e funcionalidades adicionais. 
Um exemplo comum de uso de wrappers é quando precisamos armazenar valores inteiros em uma Lista,
